# Claim Consistency Validation - 2026-06-06
...
Boundary/caveated claim mentions: **489**.
...
|---|---|---|---|
| launch_artifact_corpus_present | passed | repo_artifact | 147 launch-readiness JSON/Markdown/CSV artifacts scanned across 36829 lines. |
...
| unsupported_high_risk_claims_absent | passed | repo_artifact | 0 unsupported high-risk claim mentions; 489 mentions are in blocked/prohibited/caveated contexts. |
