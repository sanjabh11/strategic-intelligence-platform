...
Status: `forecast_evaluation_execution_readiness_partial`.

Execution ready for owner resolved export: **false**.
...
Pre-resolution owner rows present: **true**.
...
| owner_input_templates_ready | blocked | repo_artifact | 1/2 owner export templates are present with required columns. | Repair missing owner export template columns before data collection. |
...
| execution_ready_for_owner_resolved_export | blocked | repo_artifact | protocol=true; repo_surfaces=true; resolved_templates=false; pre_resolution_kit=true; pre_resolution_validator=true; science_alignment=true; accuracy_claim_allowed=false; world_class_prediction_claim_allowed=false. | Fix structural readiness before asking owner for the export. |
