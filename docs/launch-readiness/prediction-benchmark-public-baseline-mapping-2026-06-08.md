# Prediction Benchmark Public Baseline Mapping - 2026-06-08
...
| Public candidate rows | 1657 |
| Same-question candidates | 0 |
| Close public proxies | 0 |
| Diagnostic-only rows | 1657 |
...
|---:|---|---:|---|---:|---|---:|---|
| 1 | pbq-geo-escalation-001 | 0.532472 | forecastbench | 0.495 | not_comparable | 0.037472 | no_same_question_public_baseline_found |
| 2 | pbq-election-policy-002 | 0.520592 | forecastbench | 0.595 | weak_public_proxy | -0.074408 | no_same_question_public_baseline_found |
| 3 | pbq-fed-rates-003 | 0.583952 | polymarket | 0.0005 | weak_public_proxy | 0.583452 | no_same_question_public_baseline_found |
| 4 | pbq-energy-brent-004 | 0.520232 | manifold | 0.9549064276674347 | weak_public_proxy | -0.434674 | no_same_question_public_baseline_found |
| 5 | pbq-gold-safe-haven-005 | 0.491144 | forecastbench | 0.0855 | not_comparable | 0.405644 | no_same_question_public_baseline_found |
| 6 | pbq-equity-drawdown-006 | 0.468176 | polymarket | 1 | weak_public_proxy | -0.531824 | no_same_question_public_baseline_found |
| 7 | pbq-fx-sovereign-007 | 0.5324 | forecastbench | 0.495 | weak_public_proxy | 0.0374 | no_same_question_public_baseline_found |
| 8 | pbq-trade-dispute-008 | 0.516128 | forecastbench | 0.8169350142935761 | not_comparable | -0.300807 | no_same_question_public_baseline_found |
| 9 | pbq-climate-disaster-009 | 0.589856 | forecastbench | 0.8250000000000001 | not_comparable | -0.235144 | no_same_question_public_baseline_found |
| 10 | pbq-ai-regulation-010 | 0.493232 | forecastbench | 0.495 | not_comparable | -0.001768 | no_same_question_public_baseline_found |

## Provider Status

| Provider | Status | Queries | Candidates | Error |
|---|---:|---:|---:|---|
| polymarket | queried | 30 | 1563 |  |
...
| 4 | Google DeepMind | green tree | 67.9 | 604 | 0.103 |
