# Prediction Science Evidence Validation - 2026-06-07
...
| real_comparable_baselines_present | open_no_real_comparable_baselines | owner_input | 0 valid baselines; 0 real baseline comparisons; 0/0 benchmark baselines have source URLs and sample sizes. |
...
| benchmark_comparison_usable | open_benchmark_not_claim_proof | owner_input | scoring_ready=false; benchmark_status=missing; comparisons=15; source-backed baselines=0/3. |
