# Prediction Benchmark Suite - 2026-06-08
...
1. `npm run audit:forecast:benchmark-suite:validate -- --suite docs/launch-readiness/prediction-benchmark-suite-2026-06-08.json`
2. `npm run audit:forecast:validate-pre-resolution -- --question-register docs/launch-readiness/prediction-benchmark-questions-2026-06-08.csv --forecast-snapshot docs/launch-readiness/prediction-benchmark-app-snapshots-2026-06-08.csv --baseline-snapshot docs/launch-readiness/prediction-benchmark-baseline-snapshots-2026-06-08.csv --min-planned-questions 10`
